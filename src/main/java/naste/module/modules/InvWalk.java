...
import naste.events.PacketEvent;
import naste.events.TickEvent;
import naste.events.UpdateEvent;
import naste.mixin.IAccessorC0DPacketCloseWindow;
...
public class InvWalk extends Module {
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (mc.currentScreen instanceof naste.ui.ClickGui && this.guiEnabled.getValue()) {
