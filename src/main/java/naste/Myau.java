...
import naste.command.CommandManager;
import naste.command.commands.*;
import naste.config.Config;
import naste.event.EventManager;
import naste.management.*;
import naste.module.Module;
import naste.module.ModuleManager;
import naste.module.modules.*;
import naste.property.Property;
import naste.property.PropertyManager;
...
public class Myau {
    public static String clientName = "&7[&bN&3a&bs&3t&be&7]&r ";
